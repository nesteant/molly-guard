---
name: molly-roadmap
description: Read a MollyGuard roadmap slice and turn what is next in it into a change. Use when asked what to build next, to plan or prioritise work, to draft the next change, or to add something to the plan, in a repository with a mollyguard.yml.
